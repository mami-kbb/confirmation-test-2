...
class ProductsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $product->seasons()->attach([$autumn->id, $winter->id]);
        ...
        $product->seasons()->attach([$spring->id]);
        ...
        $product->seasons()->attach([$winter->id]);
        ...
        $product->seasons()->attach([$summer->id]);
        ...
        $product->seasons()->attach([$summer->id, $autumn->id]);
        ...
        $product->seasons()->attach([$spring->id, $summer->id]);
